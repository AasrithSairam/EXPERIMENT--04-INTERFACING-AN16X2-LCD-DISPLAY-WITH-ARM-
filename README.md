...
int main(void)
{
  ...
  Lcd_cursor(&lcd,1,0);
  Lcd_string(&lcd,"AMRUTHAVARSHINI");
  while (1)
  {
  }
}
...
![Screenshot 2025-04-21 091645](https://github.com/user-attachments/assets/3b7e91cf-da60-4319-a05e-04ac9f9cdeb2)

 
 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 
 ![image](https://github.com/user-attachments/assets/f19caf3c-29b6-4207-b071-106c6eeaaa7d)
